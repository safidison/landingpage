<div
    ...
    <button type="submit"
        class="ml-2 py-2 px-4 bg-[#36578A] !sm:w-[100%] lg:w-[262px] lg:h-[91px] text-white text-sm font-semibold rounded-full hover:bg-blue-600 focus:outline-none sm:sm:col-span-4 sm:h-full">
